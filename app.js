...
const INITIAL_CACHED_ITEMS = [
  ...
  { id: '2', name: 'BUBT CKT', category: 'PROJECTS', box: 'BOX_A-63 (RFL.B)', qty: 1 },
  { id: '3', name: '8 Pin IC Base', category: 'IC Base', box: 'BOX_A-57 (Lira) ESP', qty: 24 },
  { id: '4', name: '40 Pin IC Base', category: 'IC Base', box: 'BOX_A-57 (Lira) ESP', qty: 165 },
  { id: '5', name: 'ESP32', category: 'ESP', box: 'BOX_A-57 (Lira) ESP', qty: 2 },
  { id: '6', name: 'ESP8266', category: 'ESP', box: 'BOX_A-57 (Lira) ESP', qty: 2 },
  { id: '7', name: 'STM32 (blue pill)', category: 'Microcontroller', box: 'BOX_A-57 (Lira) ESP', qty: 1 },
  { id: '8', name: 'U-Lugs (Copper cable) Red', category: 'Connector', box: 'BOX_A2', qty: 26 },
  { id: '9', name: 'U-Lugs (Copper cable) Yellow', category: 'Connector', box: 'BOX_A2', qty: 25 },
  { id: '10', name: 'U-Lugs (Copper cable) Blue', category: 'Connector', box: 'BOX_A2', qty: 60 },
  { id: '11', name: 'U-Lugs (Copper cable) Black', category: 'Connector', box: 'BOX_A2', qty: 16 },
  { id: '12', name: 'Battery Clip (Red)', category: 'Clip', box: 'BOX_A2', qty: 70 },
  { id: '13', name: 'Battery Clip (Blue)', category: 'Clip', box: 'BOX_A2', qty: 70 },
  { id: '14', name: 'Heatsink', category: 'Cooling', box: 'BOX_A2', qty: 5 },
  { id: '15', name: 'Toggle Switch', category: 'Switch', box: 'BOX_A-58 (Lira) Switch', qty: 2 },
  { id: '16', name: 'Push Switch', category: 'Switch', box: 'BOX_A-58 (Lira) Switch', qty: 2 },
  { id: '17', name: 'AC Switch', category: 'Switch', box: 'BOX_A-58 (Lira) Switch', qty: 2 },
  { id: '18', name: 'Male Female 5 Pin Connector', category: 'Connector', box: 'BOX_A-58 (Lira) Switch', qty: 1 },
  { id: '19', name: 'SS Screw 3mm', category: 'Screw', box: 'BOX_A-59 (Lira) SS Screw', qty: 2 },
  { id: '20', name: 'SS Screw 4mm', category: 'Screw', box: 'BOX_A-59 (Lira) SS Screw', qty: 2 },
  { id: '21', name: '4 bridge diode (round type)', category: 'Diode', box: 'BOX_A3', qty: 5 },
  { id: '22', name: '4 bridge diode (square vertical type)', category: 'Diode', box: 'BOX_A3', qty: 2 },
  { id: '23', name: '46uH (Inductor)', category: 'Inductor', box: 'BOX_A3', qty: 10 },
  { id: '24', name: 'UF4007 diode', category: 'Diode', box: 'BOX_A3', qty: 110 },
  { id: '25', name: 'Zener diode (5V)', category: 'Diode', box: 'BOX_A3', qty: 300 },
  { id: '26', name: '1N4744 Zener diode (15V)', category: 'Diode', box: 'BOX_A3', qty: 10 },
  { id: '27', name: 'Zener diode (12V)', category: 'Diode', box: 'BOX_A3', qty: 8 },
  { id: '28', name: 'RJ45 Connector', category: 'Connector', box: 'BOX_A-60 (Lira) SS Screw', qty: 4 },
  { id: '29', name: 'Type C Cannector', category: 'Connector', box: 'BOX_A-60 (Lira) SS Screw', qty: 10 },
  { id: '30', name: 'USB Typ C Male', category: 'Connector', box: 'BOX_A-60 (Lira) SS Screw', qty: 3 },
  { id: '31', name: 'USB Male Female', category: 'Connector', box: 'BOX_A-60 (Lira) SS Screw', qty: 5 },
  { id: '32', name: '3Pin AC Socket', category: 'Socket', box: 'BOX_A6', qty: 3 },
  { id: '33', name: 'BNC Connector (Male + Female)', category: 'Connector', box: 'BOX_A6', qty: 4 },
  { id: '34', name: 'Fuse 10A', category: 'Fuse', box: 'BOX_A6', qty: 5 },
  { id: '35', name: 'Fuse 1A', category: 'Fuse', box: 'BOX_A6', qty: 25 },
  { id: '36', name: '3.3v Level converter', category: 'Module', box: 'BOX_A-61 (RFL) MODULE', qty: 4 },
  { id: '37', name: 'LM358 Module', category: 'Module', box: 'BOX_A-61 (RFL) MODULE', qty: 10 },
  { id: '38', name: '555 Function Generator Mod', category: 'Module', box: 'BOX_A-61 (RFL) MODULE', qty: 5 },
  { id: '39', name: '555 Hi cut module battery', category: 'Module', box: 'BOX_A-61 (RFL) MODULE', qty: 1 },
  { id: '40', name: 'mini pir motion sensor', category: 'Sensor', box: 'BOX_A-61 (RFL) MODULE', qty: 1 },
  { id: '41', name: 'Fuse Holder (Mini)', category: 'Fuse Holder', box: 'BOX_A7', qty: 6 },
  { id: '42', name: 'Fuse Holder (Long)', category: 'Fuse Holder', box: 'BOX_A7', qty: 1 },
  { id: '43', name: 'AC Indicator Type Switch (SPDT)', category: 'Switch', box: 'BOX_A7', qty: 7 },
  { id: '44', name: 'Mini Fuse 2A Remote Fan', category: 'Fuse', box: 'BOX_A7', qty: 7 },
  { id: '45', name: 'Winbond 25Q32FVSIG SPI Flash Memory', category: 'IC', box: 'BOX_A-62 (Lira) Components', qty: 3 },
  { id: '46', name: '10K NTC Metal square type', category: 'Sensor', box: 'BOX_A-62 (Lira) Components', qty: 10 },
  { id: '47', name: 'Load cell CKT HX711', category: 'Module', box: 'BOX_A-62 (Lira) Components', qty: 5 },
  { id: '48', name: 'led ws2812b', category: 'LED', box: 'BOX_A-62 (Lira) Components', qty: 2 },
  { id: '49', name: 'PIC Kit 2 ( USB )', category: 'Programmer', box: 'BOX_A-62 (Lira) Components', qty: 2 },
  { id: '50', name: 'PTC Fuse (XF075, 8A)', category: 'Fuse', box: 'BOX_A-62 (Lira) Components', qty: 5 },
  { id: '51', name: 'PTC Fuse (425, 1.5A)', category: 'Fuse', box: 'BOX_A-62 (Lira) Components', qty: 5 },
  { id: '52', name: 'PIC Kit 2 ( inductor 820uh )', category: 'Inductor', box: 'BOX_A-62 (Lira) Components', qty: 10 },
  { id: '53', name: 'TLP250', category: 'Optocoupler', box: 'BOX_A-62 (Lira) Components', qty: 1 },
  { id: '54', name: 'HX711', category: 'IC', box: 'BOX_A-62 (Lira) Components', qty: 2 },
  { id: '55', name: 'DK124', category: 'IC', box: 'BOX_A-62 (Lira) Components', qty: 10 },
  { id: '56', name: '12V Buzzer', category: 'Buzzer', box: 'BOX_A8', qty: 2 },
  { id: '57', name: 'LM2576', category: 'IC Regulator', box: 'BOX_A8', qty: 21 },
  { id: '58', name: 'Potentiometer (1K)', category: 'Resistor Variable', box: 'BOX_A8', qty: 2 },
  { id: '59', name: 'Potentiometer (10K)', category: 'Resistor Variable', box: 'BOX_A8', qty: 8 },
  { id: '60', name: 'Potentiometer (100K)', category: 'Resistor Variable', box: 'BOX_A8', qty: 4 },
  { id: '61', name: 'Veroboard', category: 'Board', box: 'BOX_A9', qty: 7 },
  { id: '62', name: 'Volume Knob', category: 'Hardware', box: 'BOX_A9', qty: 30 },
  { id: '63', name: 'IRFP250N', category: 'MOSFET', box: 'BOX_A10', qty: 3 },
  { id: '64', name: 'FGH40N60', category: 'IGBT', box: 'BOX_A10', qty: 5 },
  { id: '65', name: 'IRFP254N', category: 'MOSFET', box: 'BOX_A10', qty: 1 },
  { id: '66', name: 'tyn612m SCR', category: 'SCR', box: 'BOX_A10', qty: 3 },
  { id: '67', name: 'irf451', category: 'MOSFET', box: 'BOX_A10', qty: 4 },
  { id: '68', name: 'IRFP260N', category: 'MOSFET', box: 'BOX_A10', qty: 5 },
  { id: '69', name: 'TIP107', category: 'Transistor', box: 'BOX_A10', qty: 5 },
  { id: '70', name: 'TIP122', category: 'Transistor', box: 'BOX_A10', qty: 8 },
  { id: '71', name: 'MOSFET Z44', category: 'MOSFET', box: 'BOX_A10', qty: 2 },
  { id: '72', name: 'F9Z34N', category: 'MOSFET', box: 'BOX_A10', qty: 5 },
  { id: '73', name: 'TRIAC/ BTA41', category: 'Triac', box: 'BOX_A10', qty: 2 },
  { id: '74', name: 'IGBT MBQ60T65PES', category: 'IGBT', box: 'BOX_A10', qty: 9 },
  { id: '75', name: 'IRF3205', category: 'MOSFET', box: 'BOX_A10', qty: 2 },
  { id: '76', name: '18b20', category: 'Sensor', box: 'BOX_A11', qty: 3 },
  { id: '77', name: 'LM35', category: 'Sensor', box: 'BOX_A11', qty: 11 },
  { id: '78', name: 'LDR Module', category: 'Sensor', box: 'BOX_A11', qty: 1 },
  { id: '79', name: 'LDR', category: 'Sensor', box: 'BOX_A11', qty: 5 },
  { id: '80', name: 'Laser Light', category: 'Opto', box: 'BOX_A11', qty: 8 },
  { id: '81', name: 'IR Sensor Module', category: 'Sensor', box: 'BOX_A11', qty: 1 },
  { id: '82', name: 'IR Sensor 3PIN', category: 'Sensor', box: 'BOX_A11', qty: 10 },
  { id: '83', name: 'reed switch (Reed rid)', category: 'Switch', box: 'BOX_A11', qty: 5 },
  { id: '84', name: 'Infrared temperature Sensor', category: 'Sensor', box: 'BOX_A11', qty: 2 },
  { id: '85', name: 'Pin Out Circuit (8,16 Pin)', category: 'IC Socket', box: 'BOX_A12 SMD', qty: 20 },
  { id: '86', name: 'DB1075 (4 Bridge Diode)', category: 'Diode', box: 'BOX_A12 SMD', qty: 9 },
  { id: '87', name: 'HEF 4100383T', category: 'IC', box: 'BOX_A12 SMD', qty: 10 },
  { id: '88', name: 'Programming Socket', category: 'Socket', box: 'BOX_A12 SMD', qty: 1 },
  { id: '89', name: 'LM7805', category: 'Regulator', box: 'BOX_A12 SMD', qty: 30 },
  { id: '90', name: 'Voltage Regulator 3.3v', category: 'Regulator', box: 'BOX_A12 SMD', qty: 9 },
  { id: '91', name: 'ATMEGA328P', category: 'Microcontroller', box: 'BOX_A12 SMD', qty: 10 },
  { id: '92', name: 'CD4052BM', category: 'IC', box: 'BOX_A12 SMD', qty: 1 },
  { id: '93', name: 'PIC12F675', category: 'Microcontroller', box: 'BOX_A12 SMD', qty: 10 },
  { id: '94', name: '12mm Metal Nozzle', category: 'Hardware', box: 'BOX_A13', qty: 12 },
  { id: '95', name: 'PVC Spacer', category: 'Hardware', box: 'BOX_A13', qty: 6 },
  { id: '96', name: 'Linear Bearing', category: 'Hardware', box: 'BOX_A13', qty: 6 },
  { id: '97', name: 'MCP3008', category: 'IC ADC', box: 'BOX_A14', qty: 2 },
  { id: '98', name: 'PIC 16F76', category: 'Microcontroller', box: 'BOX_A14', qty: 7 },
  { id: '99', name: 'MCP41010', category: 'IC Potentiometer', box: 'BOX_A14', qty: 5 },
  { id: '100', name: 'DS1307', category: 'RTC IC', box: 'BOX_A14', qty: 4 },
  { id: '101', name: 'ATMEGA 8A', category: 'Microcontroller', box: 'BOX_A14', qty: 7 },
  { id: '102', name: 'ATMEGA 32A', category: 'Microcontroller', box: 'BOX_A14', qty: 2 },
  { id: '103', name: 'IR2110', category: 'Driver IC', box: 'BOX_A14', qty: 3 },
  { id: '104', name: 'Arduino Uno R3', category: 'Arduino', box: 'BOX_15', qty: 4 },
  { id: '105', name: 'Arduino Mega', category: 'Arduino', box: 'BOX_15', qty: 1 },
  { id: '106', name: 'Relay Module (SPDT)', category: 'Relay', box: 'BOX_15', qty: 3 },
  { id: '107', name: 'Arduino Nano', category: 'Arduino', box: 'BOX_15', qty: 7 },
  { id: '108', name: 'L293D Module', category: 'Motor Driver', box: 'BOX_15', qty: 5 },
  { id: '109', name: 'USB Module for arduino', category: 'Module', box: 'BOX_15', qty: 1 },
  { id: '110', name: '12V DC jack Converter', category: 'Connector', box: 'BOX_15', qty: 2 },
  { id: '111', name: 'ESP 8266', category: 'ESP', box: 'BOX_15', qty: 2 },
  { id: '112', name: 'Finger Print Sensor', category: 'Sensor', box: 'BOX_A-16', qty: 1 },
  { id: '113', name: 'USB ASP AVR Burner Module', category: 'Programmer', box: 'BOX_A-16', qty: 1 },
  { id: '114', name: 'Micro SD Card Reader Module', category: 'Module', box: 'BOX_A-16', qty: 2 },
  { id: '115', name: 'MP3 TF Module', category: 'Module', box: 'BOX_A-16', qty: 3 },
  { id: '116', name: 'SIM808', category: 'GSM/GPS', box: 'BOX_A-16', qty: 1 },
  { id: '117', name: 'SIM800L', category: 'GSM', box: 'BOX_A-16', qty: 2 },
  { id: '118', name: 'GPRS/GPS Module', category: 'GPS', box: 'BOX_A-16', qty: 1 },
  { id: '119', name: 'USB TTL Module', category: 'Module', box: 'BOX_A-16', qty: 1 },
  { id: '120', name: 'Logic Analyzer', category: 'Tool', box: 'BOX_A-16', qty: 1 },
  { id: '121', name: 'Soil Sensor Module', category: 'Sensor', box: 'BOX_A-16', qty: 1 },
  { id: '122', name: 'Rain Sensor Module', category: 'Sensor', box: 'BOX_A-16', qty: 1 },
  { id: '123', name: 'Weigh Scale Module HX711', category: 'Module', box: 'BOX_A-16', qty: 1 },
  { id: '124', name: 'Solar Panel', category: 'Power', box: 'BOX_A-17', qty: 2 },
  { id: '125', name: 'RFID Module', category: 'RFID', box: 'BOX_A-17', qty: 1 },
  { id: '126', name: 'RFID card', category: 'RFID', box: 'BOX_A-17', qty: 7 },
  { id: '127', name: 'Raspberry Pi zero', category: 'Single Board Computer', box: 'BOX_A-18', qty: 2 },
  { id: '128', name: 'Raspberry Pi camera', category: 'Camera', box: 'BOX_A-18', qty: 2 },
  { id: '129', name: 'HDMI Converter', category: 'Adapter', box: 'BOX_A-18', qty: 2 },
  { id: '130', name: 'M5CAM', category: 'Camera', box: 'BOX_A-18', qty: 1 },
  { id: '131', name: 'LCD Display 20x4', category: 'Display', box: 'BOX_A-19', qty: 7 },
  { id: '132', name: 'LCD Display 16x2', category: 'Display', box: 'BOX_A-19', qty: 6 },
  { id: '133', name: 'LCD Display 16x1', category: 'Display', box: 'BOX_A-19', qty: 3 },
  { id: '134', name: 'Limit Switch', category: 'Switch', box: 'BOX_A-20', qty: 15 },
  { id: '135', name: 'Toggle Switch', category: 'Switch', box: 'BOX_A-20', qty: 16 },
  { id: '136', name: '3V Battery', category: 'Battery', box: 'BOX_A-21', qty: 10 },
  { id: '137', name: 'SIM900A GSM', category: 'GSM', box: 'BOX_A-21', qty: 1 },
  { id: '138', name: 'SIM800C GSM', category: 'GSM', box: 'BOX_A-21', qty: 4 },
  { id: '139', name: 'Antenna', category: 'Antenna', box: 'BOX_A-21', qty: 3 },
  { id: '140', name: 'MicroSD Card Adapter', category: 'Module', box: 'BOX_A-21', qty: 2 },
  { id: '141', name: 'RTC Module', category: 'Module', box: 'BOX_A-21', qty: 2 },
  { id: '142', name: 'DHT22 Humidity Sensor', category: 'Sensor', box: 'BOX_A-22', qty: 2 },
  { id: '143', name: 'DHT11 Humidity Sensor', category: 'Sensor', box: 'BOX_A-22', qty: 1 },
  { id: '144', name: 'NRF24L01 Module', category: 'RF Module', box: 'BOX_A-23', qty: 3 },
  { id: '145', name: 'HC05 Bluetooth', category: 'Bluetooth', box: 'BOX_A-23', qty: 8 },
  { id: '146', name: '74HC595 Shift Register', category: 'IC Logic', box: 'BOX_A-23', qty: 20 },
  { id: '147', name: 'Optocoupler (PC817)', category: 'Optocoupler', box: 'BOX_A-25', qty: 40 },
  { id: '148', name: 'BC547 Transistor', category: 'Transistor', box: 'BOX_A-25', qty: 100 },
  { id: '149', name: '7 Segment Display (4 Digit)', category: 'Display', box: 'BOX_A-25', qty: 5 },
  { id: '150', name: '7 Segment Display (1 Digit) CA+', category: 'Display', box: 'BOX_A-25', qty: 20 },
  { id: '151', name: '7 Segment Display (1 Digit) CC-', category: 'Display', box: 'BOX_A-25', qty: 10 },
  { id: '152', name: 'LM317 Regulator', category: 'Regulator', box: 'BOX_A-27', qty: 9 },
  { id: '153', name: 'IC Base 16pin', category: 'IC Base', box: 'BOX_A-27', qty: 40 },
  { id: '154', name: 'IC Base 28pin', category: 'IC Base', box: 'BOX_A-27', qty: 20 },
  { id: '155', name: 'LED Small Green', category: 'LED', box: 'BOX_A-32', qty: 100 },
  { id: '156', name: 'LED Small Yellow', category: 'LED', box: 'BOX_A-32', qty: 100 },
  { id: '157', name: 'LED Small Red', category: 'LED', box: 'BOX_A-32', qty: 20 },
  { id: '158', name: 'IRFZ44 MOSFET', category: 'MOSFET', box: 'BOX_A-41', qty: 100 },
  { id: '159', name: 'SERVO MOTOR', category: 'Motor', box: 'BOX_A-42', qty: 100 },
  { id: '160', name: 'Arduino Nano', category: 'Arduino', box: 'BOX_A-53 (RFL) Big Box', qty: 7 },
  { id: '161', name: 'Gas Sensor MQ2', category: 'Sensor', box: 'BOX_A-53 (RFL) Big Box', qty: 4 },
  { id: '162', name: '3S BMS 40A', category: 'BMS', box: 'BOX_A-53 (RFL) Big Box', qty: 1 },
  { id: '163', name: 'ESP32 Dev Kit Module V1', category: 'ESP', box: 'BOX_A-53 (RFL) Big Box', qty: 2 },
  { id: '164', name: 'L298N Motor Driver Module', category: 'Motor Driver', box: 'BOX_A-53 (RFL) Big Box', qty: 5 },
  { id: '165', name: 'RFID-RC522 Module', category: 'RFID', box: 'BOX_A-53 (RFL) Big Box', qty: 2 },
  { id: '166', name: 'ACS-712 Current Sensor Module', category: 'Sensor', box: 'BOX_A-53 (RFL) Big Box', qty: 5 },
...
function consolidateBoxNames(items) {
  ...
  items.forEach(item => {
    if (item.box) {
      item.box = normalizeBoxName(item.box);
    }
  });
  return items;
}

function mergeWithCustomEdits(baseItems) {
  const editsJson = localStorage.getItem(STORAGE_KEY_CUSTOM_EDITS);
  if (!editsJson) return baseItems;

  try {
    const edits = JSON.parse(editsJson);
    if (!Array.isArray(edits) || edits.length === 0) return baseItems;

    const itemMap = new Map();
    // Index base items by ID
    baseItems.forEach(item => itemMap.set(String(item.id), item));

    // Overlay custom user edits and new custom items
    edits.forEach(editItem => {
      itemMap.set(String(editItem.id), editItem);
    });
...
function saveItemForm(e) {
  ...
  const rawBox = document.getElementById("formBox").value.trim() || "General Box";
  const box = normalizeBoxName(rawBox);
  ...
  if (editId) {
    ...
    showToast(`Added component "${name}" to "${box}"`, "success");
  }

  // Reset active search & filters so the newly created box/component is immediately visible on screen
  ...
  if (boxFilterEl) boxFilterEl.value = "ALL";
  activeStatusFilter = "ALL";
